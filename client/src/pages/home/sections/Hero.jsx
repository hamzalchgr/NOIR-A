  ...
  return (
    <section className="flex flex-col justify-between h-[70vh] md:h-screen">
      <div className="relative h-full flex items-center justify-center">
        <div className="absolute top-10 left-20 md:left-45 h-20 w-20 md:h-34.5 md:w-34.5 overflow-hidden">
          <img
        ...
        <div className="absolute top-10 right-20 md:right-45 h-25 w-25 md:h-34.5 md:w-34.5 overflow-hidden">
          <img
            className="h-full w-full object-center object-cover"
        ...
        <div className="absolute bottom-15 left-10 md:left-20 h-25 w-25 md:h-34.5 md:w-34.5 overflow-hidden">
          <img
            className="h-full w-full object-center object-cover"
        ...
        <div className="absolute bottom-20 md:bottom-20 right-10 md:right-20 h-28 w-28 md:h-34.5 md:w-34.5 overflow-hidden">
          <img
            className="h-full w-full object-center object-cover"
      ...
      <h1 className="text-[19.97vw] leading-none whitespace-nowrap tracking-widest">
        NOIRÉA
      </h1>
    </section>
  );
